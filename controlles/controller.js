...
//                 if (titlesArry.indexOf(result.title) == -1){
//                     titlesArry.push(result.title);
...
//       router.get("/aticles", function(req, res) {
//           Article.find()
//           .sort({_id: -1})
...
//             var articl = { Article: doc };
//             res.render("index", articl);
//           }
//         })
//     });

//     router.get("/aticles-json", function(req, re) {
